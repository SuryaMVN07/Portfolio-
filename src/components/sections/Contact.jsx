...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 sm:py-32 px-6 max-w-4xl mx-auto text-center relative z-10">
      <h2 className="text-6xl md:text-8xl font-black mb-12 reveal tracking-tighter uppercase italic text-center">{t.heading}</h2>
      <div className="bg-white/5 border border-white/10 rounded-[3rem] p-10 sm:p-16 relative overflow-hidden group reveal shadow-2xl">
        ...
        <p className="text-lg sm:text-xl font-black text-gray-300 mb-12 italic underline decoration-purple-600 underline-offset-8 decoration-4 font-medium uppercase leading-snug tracking-tighter">{t.tagline}</p>
