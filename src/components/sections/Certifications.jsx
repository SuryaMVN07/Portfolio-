  ...
  return (
    <section id="certifications" className="py-20 sm:py-32 px-6 sm:px-8 bg-white/[0.01] relative z-10">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-5xl sm:text-7xl font-black mb-16 tracking-tighter uppercase italic text-center reveal text-pink-500">{t.heading}</h2>
          ...
          {CERTIFICATIONS.map((cert, idx) => {
            ...
            return (
              <div key={idx} className="cert-card group bg-[#0a0a0a] border border-white/5 p-8 rounded-[2rem] hover:border-purple-500/40 transition-all reveal relative overflow-hidden"
                ...
                <h3 className="text-lg font-black text-white leading-tight uppercase group-hover:text-purple-400 transition-colors">
                  {translated?.title ?? cert.title}
                </h3>
